...
public class FPTC_2839_SubjectVisitAssessmentDetailsInSitePortal_SIP extends BaseTest {
	
	private String siteName;

	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_2839_SubjectVisitAssessmentDetailsInSitePortal_SIP(String browser) {
		super(browser);
	}
	...
	public void getTestData() throws Exception {
		...
		crVisitName=properties.getProperty("CRVisitName");
		
	}

	/**
	 * Test Case Id: FP-TC-2839 Test Case Name: Verify Subject,Visit,Assessment
	 * details in Site portal
	 */
	@Test(description = "FP-TC-2839 -Verify Subject,Visit,Assessment details in Site portal", groups = { "smoke" })

	public void FPTC_2839_verifySubjectVisitAssessmentDetailsInSitePortal() throws InterruptedException {
		...
		visitDetaiLPage = studyNavigatorDashBoardPage.clickOnVisitByVisitAndSubjectName(crVisitName, subjectName);
		...
		assessmentDetailPage = studyNavigatorDashBoardPage.selectByVisitAndSubjectName(crVisitName, subjectName);
