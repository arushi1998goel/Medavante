...
public class R4_FPTC_4233_CertificationCardViewCompletedTrainingWithCreditFromPreviousAssets_SIP extends BaseTest {
	...
	public void R4_FPTC_4233_CertificationCardViewCompletedTrainingWithCreditFromPreviousAssets() throws Exception
	{
		...
		String date = raterProfilePage.verifyCompletedDateIsDisplayed();
		...
		reportLog("Result Date");
		raterProfilePage.verifyRespectiveOptionOnAssetToolTip(Constants.Asset_result_date);
		...
		raterProfilePage.verifyRespectiveOptionOnTrainingToolTip(Constants.AT_Trainingname);
		...
		dashBoardPage = loginPage.siteLogin(RaterViewOnly_Test, VU_AT_Password);
