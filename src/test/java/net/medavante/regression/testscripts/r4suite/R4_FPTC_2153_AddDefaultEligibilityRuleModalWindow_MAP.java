...
public class R4_FPTC_2153_AddDefaultEligibilityRuleModalWindow_MAP extends BaseTest {
	...
	public R4_FPTC_2153_AddDefaultEligibilityRuleModalWindow_MAP(String browser) {
		super(browser);
	}
    ...
    public void R4_FPTC_2153_AddDefaultEligibilityRuleModalWindow()
    {
    	...
    	reportLog("2.0: Log in to the MA Portal as User Pr.#3");
