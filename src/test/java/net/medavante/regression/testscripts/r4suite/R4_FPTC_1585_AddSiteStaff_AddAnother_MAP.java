...
public class R4_FPTC_1585_AddSiteStaff_AddAnother_MAP extends BaseTest {
	...
	public void getTestData() throws Exception {
		...
		studyName2 = properties.getProperty("Automation_Study1585");
	...
	public void R4_FPTC_1585_AddSiteStaff_AddAnother() throws Exception {
		...
		ratersDetailsPage.selectStudyFromStudyDropDownOptions(studyName1);
		...
		ratersDetailsPage.clickOnPopUpTitle(Constants.siteRaterWindowTitle);
		ratersDetailsPage.selectStudyFromStudyDropDownOptions(studyName2);
		ratersDetailsPage.searchAndSelectSite(Constants.ATAssignedRater_10, Constants.Add_SiteRater_PopUp);
		ratersDetailsPage.selectUserRoleOnAddStaffPopUp();
