...
* @date 26/06/2020
* =======================================================================================================================================
*  Test Case Id: FP-TC-2656   Test Case Name: Certification Card - View completed Training - V21
*  Pre-qualification : 1. At least one User exists
                       2. At least one General training is completed by the User Pr#1. Training's assets previously were not completed by the User. Training contains at least 2 events:
                       2.1 Event 1 contains an Asset
                       2.2 Event 2 contains Course with 2 Assets
                       3. At least one Form based training is failed by the User Pr#1. Training's assets previously were not completed by the User. Training contains at least 2 events:
                       3.1 Event 1 contains an Asset and it's passed
                       3.2 Event 2 contains Course with 2 Assets and it's failed
                       4. At least one training is assigned to the User Pr#1 which is not started
* ======================================================================================================================================= 
...
public class R4_FPTC_2656_CertificationCardViewCompletedTraining_SIP extends BaseTest {
	...
	private String study, trainingName=" Training ";
    ...
    @Test(description="Certification Card - View completed Training - V21",  groups = { "R4" })
    ...
    { 
		...
		dashBoardPage = loginPage.loginInApplication(RaterCertificationCardView_Test, VU_AT_Password);
		...
		raterProfilePage.verifyCertificationCardDisplayed(study);
		...
		raterProfilePage.verifyTrainingIsDisplayedAsHyperlink(Constants.Training_Name_1);
		...
		raterProfilePage.completedTrainingModalWindowIsDisplayed(Constants.Training_1);

		reportLog("Name - [Training Display name] Pr#2");
		raterProfilePage.verifyRespectiveFieldIsDisplayed(Constants.fieldName,Constants.Training_1);
		...
		raterProfilePage.verifyTrainingNameIsDisplayed(Constants.Training_1);
		
		reportLog("Option to view Training name tool-tip"); 
		raterProfilePage.verifyOptionToViewTrainingToolTipIsDisplayed(Constants.Training_1);
		...
		raterProfilePage.verifyAssetAsHyperLinkDisplayed(Constants.Asset_Name1);
		
		reportLog("5.0: Click on the option to view Training name tool-tip");
		raterProfilePage.clickOnTheTrainingToolTipOption(Constants.Training_1);
		
		reportLog("5.1: Tool-tip is displayed with such information:"); 
		reportLog("Training Name"); 
		raterProfilePage.verifyRespectiveOptionOnTrainingToolTip(Constants.Training_1);
		...
		reportLog("Result"); 
		raterProfilePage.verifyRespectiveOptionOnTrainingToolTip(Constants.TrainingStatus);
		...
		raterProfilePage.hoverOverAssetToolTip(Constants.Asset_Name1);
		
		reportLog("6.1: Asset name tool tip is displayed with such information:"); 
		reportLog("Asset Name"); 
		raterProfilePage.verifyRespectiveOptionOnAssetToolTip(Constants.Asset_Name1);
		...
		raterProfilePage.clickOntheAssetName(Constants.Asset_Name1);
		...
		raterProfilePage.verifyCertificationCardDisplayed(study);
		raterProfilePage.clickOnAllOptionForEnable(study);
