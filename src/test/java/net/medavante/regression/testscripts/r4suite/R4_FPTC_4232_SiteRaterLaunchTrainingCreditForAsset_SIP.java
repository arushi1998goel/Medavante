...
public class R4_FPTC_4232_SiteRaterLaunchTrainingCreditForAsset_SIP extends BaseTest {
	...
	public void getTestData() throws Exception {
		...
		ratersDetailsPage.applyNameFilterUnderTrackingTab(Constants.RaterForAssertCredit);
		ratersDetailsPage.selectRater(Constants.RaterForAssertCredit);
		ratersDetailsPage.verifyRaterIsSelected(Constants.RaterForAssertCredit);
	...
	public void R4_FPTC_4232_SiteRaterLaunchTrainingCreditForAsset() throws InterruptedException {
		...
		dashBoardPage.eSignature(RaterAssetCredit_Test, VU_AT_Password);
