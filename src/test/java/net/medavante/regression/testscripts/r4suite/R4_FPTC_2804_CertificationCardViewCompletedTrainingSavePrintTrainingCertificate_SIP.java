...
public class R4_FPTC_2804_CertificationCardViewCompletedTrainingSavePrintTrainingCertificate_SIP extends BaseTest {
	...
	{ 
		...
		dashBoardPage = loginPage.loginInApplication(RaterForCertificationCard_Test, VU_AT_Password);
		...
		raterProfilePage.selectTrainingWithTwoAssets(study);
		...
		String completedDate = raterProfilePage.selectrOptiontoPrintCertificate();
		...
		raterProfilePage.verifyRaterDetailsDisplayed(Constants.RaterName,Constants.Rater_Training,completedDate);
