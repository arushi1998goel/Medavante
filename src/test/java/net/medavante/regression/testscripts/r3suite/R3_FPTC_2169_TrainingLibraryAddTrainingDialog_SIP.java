...
public class R3_FPTC_2169_TrainingLibraryAddTrainingDialog_SIP extends BaseTest {
	...
	private String LibraryNameValid="Auto_Library"+generateRandomString(10),
			Description="Auto_description"+generateRandomAlphanumericString(600),
			DisplayName="Auto_Display"+generateRandomString(150);
