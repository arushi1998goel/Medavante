...
public class FPTC_2695AccessCRSourceClaim_SIP extends BaseTest {
	...
	public void getTestData() throws Exception {
		...
		visitName = prop.getProperty("VisitAccessSource");
		  ...
		  //Creating Subject For Configuring Pre-requisite reportLog("Setting up PRs");
		  dashBoardPage = loginPage.loginInApplication(SuperAdminUN, SuperAdminPW);
		  dashBoardPage.verifyMedavantePortalPage(); studyNavigatorDashBoardPage =
		  dashBoardPage.selectHorizontalUpperNavMenuItem(StudyDashBoardPage.class,
		  Constants.NavigateText, Constants.StudyText);
		  studyNavigatorDashBoardPage.creatingSubjectForPreRequisite(
		  studyForAssessmentListing, Constants.ATAssignedRater_10, subjectName);
		  ...
		  subjectDetailPage.verifyRaterAssignmentDropDownSelectedValue(Constants.
		  ATAssignedRater_12); assessmentDetailPage=subjectDetailPage.
	...
	public void FPTC_2695verifyUserAccessCRSourceClaimsFlow() {
		...
		reportLog("1: Login in to application  " + AT_PRODInvestigatorRater + " ");
		...
		assessmentDetailPage = studyNavigatorDashBoardPage
				.selectByAssesmentNameAndVisitAndSubjectName(Constants.Assessment_CGI_S, visitName, subjectName);
