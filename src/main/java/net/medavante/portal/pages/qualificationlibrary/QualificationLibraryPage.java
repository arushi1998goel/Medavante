...
public class QualificationLibraryPage extends BasePage {
	...
	*/
	public void selectOptionToAddQualificationGroup()
	{
		...
		waitForElementToBecomeInvisible(By.xpath("//div[@class='ma-spinner-interceptor']"));
		reportInfo();
	}
	/*
	...
	*/
	...
	{
		waitForElementToBecomeInvisible(By.xpath("//div[@class='ma-spinner-interceptor ng-star-inserted']"));
