...
public class RaterProfilePage extends BasePage {
	...
	@FindBy(xpath = "//div[@class='data-table-items']/div")
	...
	@FindBy(xpath = "(//label[@class='completed-date'])[1]")
	private WebElement trainingCompletedDate;

	@FindBy(xpath = "//time[@class='date']")
	...
	public void closeTrainnigCertificate() {
		moveToElement(closeTrainingCertificateBtn);
		javascriptButtonClick(closeTrainingCertificateBtn);
		waitUntillFinishSpinnerProcessDisable();
		reportInfo();
	}
	...
	public void closeCertificationCard() {
		moveToElement(closeCertificationcardBtn);
		javascriptButtonClick(closeCertificationcardBtn);
		waitUntillFinishSpinnerProcessDisable();
		reportInfo();
	}
	 ...
	 */
	public void verifyCertificationCardDisplayed(String study) {
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@class='ma-spinner']")));
		WebElement expandIcon = driver
				.findElement(By.xpath("//span[contains(text(),'" + study + "')]/parent::div/parent::div"));
		if (expandIcon.getAttribute("class").contains("collapsed")) {
			javascripctHilightingElement(expandIcon);
		}
		this.selectAllOptionOnScaleCertificationTab(study);
		// Assert.assertTrue(isElementDisplayed(certificationCardSection));
		reportInfo();
	}

	public void selectAllOptionOnScaleCertificationTab(String study) {
		WebElement allopt = driver.findElement(By.xpath("//span[contains(text(),'" + study
				+ "')]/parent::div/parent::div/div//strong[text()='Scale certification']/parent::div//label"));
		if (allopt.isDisplayed()) {
			if (!allopt.getAttribute("class").contains("checked")) {
				javascriptButtonClick(allopt);
			}
		}
	}
	 ...
	 */
	public void selectTrainingWithTwoAssets(String study) {
		WebElement allopt = driver.findElement(By.xpath("//span[contains(text(),'" + study
				+ "')]/parent::div/parent::div/div//strong[text()='Study Onboarding']/parent::div//label"));
		if (!allopt.getAttribute("class").contains("checked")) {
			javascriptButtonClick(allopt);
		}
	...
	public void clickOnAllOptionForEnable(String study) {
		WebElement allopt = driver.findElement(By.xpath("//span[contains(text(),'" + study
				+ "')]/parent::div/parent::div/div//strong[text()='Study Onboarding']/parent::div//label"));
		if (allopt.isDisplayed()) {
			if (!allopt.getAttribute("class").contains("checked")) {
	 ...
	 */
	public String selectrOptiontoPrintCertificate() {
		moveToElement(trainingCompletedDate);
		String date = getText(trainingCompletedDate);
	...
	public void verifyRaterDetailsDisplayed(String ratername, String TrainingName, String completionDate) {
		...
		WebElement trainingToBeVerify = driver
				.findElement(ByLocator("//strong[contains(text(),'" + TrainingName + "')]"));
		...
		String dateToBeVerified = date.getText();
		moveToElement(date);
		Assert.assertTrue(dateToBeVerified.equalsIgnoreCase(completionDate) && trainingToBeVerify.isDisplayed()
				&& raterName.isDisplayed());
	}
	...
	public void verifyTrainingIsDisplayedAsHyperlink(String TrainingName) {
		...
		WebElement elementToBeVerified = driver.findElement(ByLocator(
				"//strong[@class='group-heading pull-left link' and contains(text(),'" + TrainingName + "')]/.."));
	...
	public void verifyTrainingIsDisplayed(String TrainingName) {
		waitUntillFinishProcessSpinnerDisable();
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//strong[contains(text(),'" + TrainingName + "')]/.."));
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	...
	public void selectTraining(String TrainingName) {
		WebElement trainingToBeSelected = driver
				.findElement(ByLocator("//strong[contains(text(),'" + TrainingName + "')]"));
	...
	public void completedTrainingModalWindowIsDisplayed(String TrainingName) {
		waitUntillFinishProcessSpinnerDisable();
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//span[contains(text(),'" + TrainingName + "')]"));
	...
	public void verifyRespectiveFieldIsDisplayed(String fieldName, String expectedvalue) {
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//span[text()='" + fieldName + "']/following-sibling::div"));
	...
	public void verifyAssetAsHyperLinkDisplayed(String assetName) {
		...
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//span[text()='" + assetName + "'and @class='link-mode']"));
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	}
	...
	public void clickOntheAssetName(String assetName) {
		nameLabel.click();
		WebElement elementToBeClicked = driver
				.findElement(ByLocator("//span[text()='" + assetName + "'and @class='link-mode']"));
	 ...
	 */
	public String verifyCompletedDateIsDisplayed() {
		moveToElement(completedDate);
		Assert.assertTrue(isElementDisplayed(completedDate));
		String date = completedDate.getText();

		SimpleDateFormat source = new SimpleDateFormat("dd-MMMM-YYYY"); // British format
	...
	public void verifyTrainingNameIsDisplayed(String trainingName) {
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("(//strong[@class='name' and contains(text(),'" + trainingName + "')])[1]"));
		moveToElement(elementToBeVerified);
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	}
	...
	public void verifyAssetWithCreditLabel(String assetName) {
		WebElement assetToBeVerified = driver.findElement(
				ByLocator("//span[text()='" + assetName + "']/../following::div[2]/span[text()='Credit']"));
	...
	public void hoverCursorOverRespectiveToolTip(String assetName) {
		WebElement assetToBeVerified = driver.findElement(ByLocator(
				"//span[text()='" + assetName + "']/../following::div[2]//span[@class='icon-small icon-info']"));
		moveToElement(assetToBeVerified);
		Assert.assertTrue(isElementDisplayed(assetToBeVerified));
		reportInfo();
	}
	...
	public void verifyOptionToViewTrainingToolTipIsDisplayed(String trainingName) {
		WebElement elementToBeVerified = driver.findElement(ByLocator("//strong[@class='name'][ contains(text(),'"
				+ trainingName + "')]/../following::span[@class='details-popup']"));
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	}
	...
	public void clickOnTheTrainingToolTipOption(String trainingName) {
		WebElement elementToBeVerified = driver.findElement(
				ByLocator("(//strong[@class='name'][contains(text(),'" + trainingName + "')]/..)[1]/span/span"));
	...
	public void verifyRespectiveOptionOnTrainingToolTip(String elementName) {
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//div[@class='k-popup']//strong[2][contains(text(),'" + elementName + "')]"));
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	}
	...
	public void verifyRespectiveOptionOnAssetToolTip(String elementName) {
		WebElement elementToBeVerified = driver
				.findElement(ByLocator("//div[contains(@class,'popup-box')]//strong[text()='" + elementName + "']"));
		Assert.assertTrue(isElementDisplayed(elementToBeVerified));
		reportInfo();
	}
	...
	public void verifyTrainingResult(String assetName, String expectedTxt) {
		WebElement elementToBeVerified = driver.findElement(ByLocator("//span[text()='" + assetName
				+ "']/ancestor::div[contains(@class,'data-row ng')]//div[@class='note-column']/span"));
