...
public class AdministrationStudiesPeoplePage extends BasePage {
	...
	@FindBy(xpath = "//h4[@id='confirmationLabel']/strong")
	private WebElement confirmationPopUp;
	
	@FindBy(xpath = "//div[text()='Save anyway']")
	private WebElement saveAnyWayBtn;
	...
	public void verifyConfirmationPopUpAndClickOnSaveAnyWayButton() {
		boolean flag = false;
		moveToElement(confirmationPopUp);
		if(confirmationPopUp.isDisplayed()) {
			moveToElement(saveAnyWayBtn);
			saveAnyWayBtn.click();
			waitForSpinnerBecomeInvisible(15);
			flag =true;
		}
