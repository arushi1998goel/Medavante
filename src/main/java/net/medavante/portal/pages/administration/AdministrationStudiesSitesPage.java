...
public class AdministrationStudiesSitesPage extends BasePage {
	...
	@FindBy(xpath="//div[@id='study-qualification-groups-dialog']//h4[text()='Confirmation']")
	private WebElement confirmationPopUp;
	
	@FindBy(xpath= "//div[@id='study-qualification-groups-dialog']//span[text()='Add people anyway']")
	private WebElement addPeopleAnyWayBtn;
 ...
 */
	public void AddNewSite(String siteName, String facilityName, String sitePeople, String systemRole,
		...
		moveToElement(confirmationPopUp);
		waitAndClick(addPeopleAnyWayBtn);
		selectSitePeopleRoleAccess(systemRole);
		waitAndClick(peopleSaveBTN);
		waitForElementToBecomeInvisible(By.xpath("//div[@data-ng-show='ctx.isBusy' and @class='ng-isolate-scope']"));
		reportInfo();
	...
	@FindBy(xpath="(//label[text()='Add People'])[3]/..//div[@class='grid-line grid-row ng-scope']")
