...
public class MedAvantePortalPage extends BasePage {
	...
	@FindBy(xpath="//header[@id='header']//*[@title='Virgil']")
    ...
    @FindBy(xpath = "//span[text()='Application Training']/parent::div/parent::div")
    private WebElement applicationTrainingTab;
    
    @FindBy(xpath = "//span[contains(text(),'General Training')]")
    private WebElement generalTraining;
    
    @FindBy(xpath = "//span[contains(text(),'General Trainings')]//ancestor::div[@class='user-column-holder']//div[@class='col-scrolled-box']/div//strong[@title='View Training']")
	private List<WebElement> generalTrainingList;
   ...
   */
    ...
    {
    	waitUntillFinishProcessSpinnerDisable();
    	for(WebElement training : generalTrainingList) {
			String trainingsName=training.getText();
			boolean flag =false;
			if(trainingName.contains(trainingName)) {
				flag=true;
			}
...
_normalWait(3000); 
     ...
     */
    public void closeAsset() throws InterruptedException{
    ...
    /**
     * verify general training area is displayed
     */
	...
	/**
	 * verify assets are displayed in the complete asset list
	 * @param asset
	 */
	...
	public void verifyTrainigIsStartedFromAssetTwo(String Asset) {
		WebElement completeAsset =driver.findElement(By.xpath("//span[text()='"+Asset+"']/../../../../span[text()='Current Progress:']"));	
		moveToElement(completeAsset);
		Assert.assertTrue(completeAsset.isDisplayed());
    	reportInfo();
	}
	...
	public void clickOnDoneButtonForCompleteAsset() throws InterruptedException {
		waitUntillFinishProcessSpinnerDisable();
