...
public class CentralRatingAppointmentPage extends BasePage {
	...
	@FindBy(xpath = "//div[@class='modal-footer']/div[@class='btn btn-default' and @data-ng-click='onCancelAppointmentCancelation()']")
	private WebElement popUpNoBTNForCancelAppointment;

	@FindBy(xpath = "//div[@id='queryConfirmation']//div[@class='btn btn-active' and @data-ng-click='okClick()']")
...
//		waitSpinnerToBecomeInvisible();
	...
	/* Click On Update Appointment Button */
	public void clickOnUpdateAppointment() {
		waitAndClick(updateAppointmentBTN);
		waitForElementToBecomeInvisible(By.xpath("//div[@data-ng-show='isBusy' and @class='ng-isolate-scope']"));
	...
	public void verifyScheduledClinicanIsShown() {
		Assert.assertTrue(clinicanNamelinkTXT.getText().contains("AT Clinician"));
	}
