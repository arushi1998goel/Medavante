...
public class PreQualificationDashBoardPage extends BasePage {
	...
	@FindBy(xpath = "//h1[contains(text(),'Quali')]")
	...
	@FindBy(xpath = "//*[contains(@data-display-value,'selectedSite')]//button[contains(@class,'btn dropdown-toggle')]")
	private WebElement selectSiteDRPDWN;
	
	@FindBy(xpath = "//div[@class='btn-group ng-isolate-scope open']//ul[contains(@class,'dropdown-menu')]/li/span")
	private WebElement searchSiteDRPDWN;
	
	@FindBy(xpath = "//div/h1[contains(text(),'Qualification Summary')]")
	private WebElement pageHeader;

    @FindBy(xpath = "//div[text()='Add Group']")
	private WebElement addGroupButton;

    @FindBy(xpath="//span[@class='icon-small icon-refresh-b']")
	...
	public void verifySelectedPageIsDisplayed() {
	...
	/**
	 * verify qualification libraby page is displayed
	 */
	
	public void verifyQualificationLibraryPageIsDisplayed() {
		_normalWait(3000);
		Assert.assertTrue(addGroupButton.isDisplayed());
	}
